...
const Navbar = () => {
  ...
  return (
    <div className="text-white/70 pt-6">
        <div className="hidden md:flex items-center text-center px-4 py-2 mx-auto max-w-[580px]">
                ...
                <li>
                    <a href="#contact" className="group">
                        ...
                        <div className="relative">
                            <div className="absolute w-2/3 h-1 transition-all duration-300 ease-out rounded-full group-hover:w-full"
                            style={{
                                background: 'linear-gradient(to right, #462523 0%, #cb9b51 22%, #f6e27a 45%, #f6f2c0 50%, #f6e27a 55%, #cb9b51 78%, #462523 100%)',
                              }}
                              ></div>
                            <div className="mt-1 absolute w-1/3 h-1 transition-all duration-300 ease-out rounded-full group-hover:w-full"
                            style={{
                                background: 'linear-gradient(to right, #462523 0%, #cb9b51 22%, #f6e27a 45%, #f6e27a 50%, #f6e27a 55%, #cb9b51 78%, #462523 100%)',
                              }}
                              ></div>
                        </div>
                    </a>
